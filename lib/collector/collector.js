  ...
  _createClass(Collector, [{
    ...
    value: function connect() {
      ...
      _callback_api2.default.connect(_config2.default.amqp.uri, function (err, connection) {
        ...
        console.log('Collector is connected to "' + _config2.default.amqp.uri + '" and waiting for results.');
    ...
    value: function run(channel) {
      ...
      console.log('Collector is consuming results at channel "' + _config2.default.amqp.queues.collector + '"');
